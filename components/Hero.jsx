      ...
      <div className="container">
        <div className="hero-content-clean">
          ...
          <div className="hero-actions">
            ...
            <button 
              className="btn btn-secondary btn-open-resume" 
          ...
          <div className="hero-socials-clean">
            <a href="https://www.linkedin.com/in/arsalan-qayum-19a429225" target="_blank" rel="noopener noreferrer" className="hero-social-link" title="LinkedIn Profile">
