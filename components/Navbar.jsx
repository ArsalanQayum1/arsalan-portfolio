    ...
    <header className={`navbar ${scrolled ? 'scrolled' : ''}`} id="navbar">
      <div className="container navbar-container">
        ...
        <div className="nav-cta desktop-cta">
          ...
          <a href="#contact" className="btn btn-primary btn-sm" id="nav-contact-btn">
            <span>Contact</span>
          </a>
        </div>
        ...
        <div className="mobile-header-controls">
          <button className="btn btn-secondary btn-sm btn-open-resume" id="mobile-nav-top-resume-btn" title="View Resume">
            Resume
          </button>
          <button 
